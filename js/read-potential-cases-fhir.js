...
(async () => {
  ...
  await fs.writeFile("syndrome-of-inappropriate-secretion-of-antidiuretic-hormone-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("syndrome-of-inappropriate-secretion-of-antidiuretic-hormone-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
